    ...
    const items = [
      {
        ...
        a: `Круглосуточное отделение: палаты, питание по режиму, назначения под наблюдением нарколога и персонала; терапию корректируют по динамике — в отличие от амбулаторного формата. Сутки в ${city.namePrep} — от ${city.priceStacionarDay.toLocaleString('ru')} ₽ ориентир; полный срок и сумма — на линии и с врачом после осмотра.`,
      },
      {
