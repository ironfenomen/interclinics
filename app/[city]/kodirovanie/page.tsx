          ...
          <div className={`c ${styles.heroScene}`}>
            <div className={styles.heroMain}>
              ...
              <p className={styles.lead}>
                Ориентир по трезвости — часто 3–5 суток; точный срок задаёт врач. Формат подбирают индивидуально. Консультация и план — спокойно, без давления и без
                обещаний «универсального» результата.
              </p>
          ...
          <div className={`c ${styles.methodsInner}`}>
            <header className={styles.methodsHeader}>
              ...
              <p className={styles.methodsLead}>
                Ниже — ориентиры по форматам: их обсуждают после осмотра и оценки трезвости. Цена и срок на экране не заменяют консультацию — итог всегда на приёме.
              </p>
            </header>
            ...
            <p className={styles.methodsFootnote}>
              Ориентиры не заменяют осмотр: срок и вариант согласуют с врачом по показаниям — после достаточной трезвости.
            </p>
          </div>
        </section>
